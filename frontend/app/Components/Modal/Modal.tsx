...
function Modal() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (modalMode === "edit") {
      success = await updateTask(taskData);
  ...
  return (
    <div className="fixed left-0 top-0 z-50 h-full w-full bg-[#333]/30 overflow-hidden">
      <form
        action=""
        className="py-5 px-4 md:px-6 max-w-[520px] w-[calc(100%-1.5rem)] md:w-full flex flex-col gap-3 bg-white absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-lg shadow-md max-h-[90vh] overflow-y-auto"
      ...
      >
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between bg-[#F9F9F9] p-2 rounded-md border">
