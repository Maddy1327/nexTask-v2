...
function TaskItem({ task }: TaskItemProps) {
  ...
  return (
    <motion.div
      className="min-h-[16rem] px-4 py-3 flex flex-col gap-4 shadow-sm bg-[#f9f9f9] rounded-lg border-2 border-white"
      variants={item}
    >
      <div>
        <h4 className="font-bold text-xl md:text-2xl">{task.title}</h4>
