...
function Filters() {
  ...
  return (
    <div className="relative w-full max-w-full py-2 px-2 grid grid-cols-4 items-center gap-1 md:gap-3 bg-[#F9F9F9] border-2 border-white rounded-md overflow-hidden">
      <span
      ...
      {priorities.map((priority, index) => (
        <button
          key={index}
          className={`relative px-1 z-10 font-medium text-xs md:text-sm ${
